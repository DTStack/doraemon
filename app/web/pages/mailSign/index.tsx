    ...
    createImg() {
        html2canvas(this.el, {
            ...
            this.setState({
                ...
                setTimeout(() => {
                    const h: any = document.getElementById('j-pic').getBoundingClientRect().height;
    ...
    render() {
        ...
        return (
            <div className="mail-sign">
                    ...
                    {this.state.image &&
                        <div>
                            <div style={{ width: 400, maxHeight: 600 }}>
                                <img key={previewImgSrc} src={previewImgSrc} ref={(node: any) => this.previewImg = node} style={{ maxWidth: '100%' }} />
                            </div>
                            <p className="form-item">
                ...
                <hr />
                <div className="m-box" id="j-preview" style={{ position: 'relative' }} ref={(el: any) => this.el = el}>
                    <p style={{
                        position: 'absolute',
                    ...
                    <div className="avatar"
                        style={{
                            width: 138, height: 138, borderRadius: 69, overflow: 'hidden',
                ...
                <div className="img" ref={(box: any) => this.box = box} style={{ height: 250, border: '1px dashed #ccc', padding: 10 }}>
