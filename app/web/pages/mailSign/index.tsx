...
export default class MainSign extends React.PureComponent<any, any> {
    state: any = {
        name: '',
        nick: '',
        phone: '',
    ...
    createImg() {
        html2canvas(this.el, {
            ...
            this.setState(
                ...
                () => {
                    setTimeout(() => {
                        const h: any = document
                            .getElementById('j-pic')
            ...
            <div className="mail-sign">
                <div className="form">
                    ...
                    <p className="form-item">
                        <span>姓名：</span>
                        <input onChange={this.handleClick.bind(this)} type="text" name="name" />
                    </p>
                    <p className="form-item">
                        <span>花名：</span>
                        <input onChange={this.handleClick.bind(this)} type="text" name="nick" />
                    </p>
                    <p className="form-item">
                        <span>职位：</span>
                        <input onChange={this.handleClick.bind(this)} type="text" name="title" />
                    </p>
                    <p className="form-item">
                        <span>电话：</span>
                        <input onChange={this.handleClick.bind(this)} type="text" name="phone" />
                    </p>
                    <p className="form-item">
                        <span>邮箱：</span>
                        <input onChange={this.handleClick.bind(this)} type="text" name="mail" />
                    </p>
                    <p className="form-item">
                        <span>地址：</span>
                        <input onChange={this.handleClick.bind(this)} type="text" name="addr" />
                    </p>
                    <p className="form-item">
                        <span>头像: </span>
                        ...
                        <div>
                            <div style={{ width: 400, maxHeight: 600 }}>
                                <img
                                    key={previewImgSrc}
                                    src={previewImgSrc}
                                    ref={(node: any) => (this.previewImg = node)}
                                    style={{ maxWidth: '100%' }}
                                />
                            </div>
                            <p className="form-item">
                ...
                >
                    ...
                    >
                        {name}
                        <span style={{ color: '#38A5C9' }}>（{nick}）</span>
                    </p>
                    <p
                        style={{
                            position: 'absolute',
                ...
                <div
                    className="img"
                    ref={(box: any) => (this.box = box)}
                    style={{ height: 250, border: '1px dashed #ccc', padding: 10 }}
                >
