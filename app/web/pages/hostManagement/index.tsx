        ...
        return (
            <div>
                <Row gutter={16}>
                    ...
                    <Col span={12}>
                        <Paragraph
                            editable={{ onChange: handleTextChange.bind(this, row, 'username') }}
                ...
                <Row gutter={16} style={{ marginTop: 14 }}>
                    ...
                    <Col span={12}>
                        <Paragraph
                            editable={{
                                editing: false,
                                onStart: handlePasswordEdit.bind(this, row),
                            }}
                ...
                <Row gutter={16} style={{ marginTop: 14 }}>
                    ...
                    <Col span={12}>
                        <Paragraph copyable={{ text: sshText }}>{sshText}</Paragraph>
                    </Col>
                </Row>
            </div>
        );
        ...
        <div className="page-host-management">
            <div className="title_wrap">
                <Search
                    ...
                    style={{ width: 220 }}
                />
                <Button type="primary" icon={<PlusCircleOutlined />} onClick={handleHostAdd}>
                    新增主机
                </Button>
            </div>
            <Table
